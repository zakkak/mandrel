...
public final class VMInspectionOptions {
    ...
    private static final List<String> NOT_SUPPORTED_ON_WINDOWS = List.of(MONITORING_JVMSTAT_NAME, MONITORING_JMXCLIENT_NAME, MONITORING_JMXSERVER_NAME, MONITORING_JCMD_NAME);
